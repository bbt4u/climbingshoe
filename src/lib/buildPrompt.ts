...
Use these signals alongside the photo to estimate forefoot width, heel width, and overall volume. Present width as an estimate.`;
  ...
  const scanNote = "MEASUREMENT: Analyze foot shape and proportions from the photo. If A4 paper (210×297mm) is visible under the feet, use it as a size reference to calibrate foot length, forefoot width, and heel width. If no A4 paper is visible, estimate proportions from the photo alone using relative ratios.";
